...
public class Shape_1Index extends Fragment {
    String name;
    int imageID;
    ...
    public Shape_1Index(String name, int imageID, androidx.fragment.app.Fragment fragment){
        this.name = name;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shape_1index, container, false);
    }
        ...
        shapeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shapeResult.setText(String.valueOf(shape2D.runCalculate
                        (Float.parseFloat(shapeNum1.getText().toString()), 0, 0)) + " cm²");
            }
        });
